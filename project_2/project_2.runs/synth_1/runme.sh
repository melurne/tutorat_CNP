...
HD_PWD='C:/Users/electro/Documents/GitHub/tutorat_CNP/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log REG.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source REG.tcl
